import{H as E,d as ee,b8 as Se,av as Be,n as B,an as Te,b6 as Pe,R as p,G as b,aO as ke,bc as oe,aq as Re,J as g,aE as l,aG as Y,aF as He,L as re,at as Ie,ar as Ee,b as R,K as Oe,b0 as _e,$ as Fe,N as r,aD as H,O as De,aJ as U,bd as je,aI as Ne,aK as Ke,S as Ge,aL as Me}from"./index-5a30c5d4.js";import{i as O}from"./is-browser-fc34c9a6.js";import{u as Ve}from"./use-form-item-6ff12fff.js";import{c as Z}from"./color-to-class-b0332f36.js";const We=E("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),qe=ee({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){Se("-base-wave",We,Be(e,"clsPrefix"));const f=B(null),h=B(!1);let u=null;return Te(()=>{u!==null&&window.clearTimeout(u)}),{active:h,selfRef:f,play(){u!==null&&(window.clearTimeout(u),h.value=!1,u=null),Pe(()=>{var v;(v=f.value)===null||v===void 0||v.offsetHeight,h.value=!0,u=window.setTimeout(()=>{h.value=!1,u=null},1e3)})}}},render(){const{clsPrefix:e}=this;return p("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:C}=ke;function Qe({duration:e=".2s",delay:f=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 margin-left ${e} ${C},
 margin-right ${e} ${C};
 `)]}const Le=O&&"chrome"in window;O&&navigator.userAgent.includes("Firefox");const Ae=O&&navigator.userAgent.includes("Safari")&&!Le;function $(e){return oe(e,[255,255,255,.16])}function I(e){return oe(e,[0,0,0,.12])}const Je=Re("n-button-group"),Xe=b([E("button",`
 margin: 0;
